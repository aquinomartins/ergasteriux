...
start_app_session();
?>
<section class="spa-module-shell" data-view-root="mercado-lmsr">
  <header class="market-hero">
    <div>
      ...
      <p class="market-hero__subtitle subtle">
        Use o módulo local /api/* com contrato JSON canônico yes/no (compatível com SIM/NAO durante transição).
      </p>
    </div>
  ...
  <section class="market-actions">
    <div class="card">
      ...
      <form data-role="create-market-form">
        ...
        <label>Risco máximo (BRL)<input type="number" name="risk_max" step="0.01" min="1" placeholder="100" /></label>
        <label>Taxa (%)<input type="number" name="fee_rate" step="0.01" min="0" value="1" /></label>
        <label>Buffer (%)<input type="number" name="buffer_rate" step="0.01" min="0" value="15" /></label>
